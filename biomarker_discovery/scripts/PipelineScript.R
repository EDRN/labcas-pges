...
# FIXME
write("prints to stdout arguments=" <- arguments, stdout())
...
trainClass <- Class2Binary(trainDataSet$trait,case="case",control="control")
testClass <- Class2Binary(testDataSet$trait,case="case",control="control")
